      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Text("Cari order ...", style: TextStyle(color: Colors.grey[600])),
          ],
        ),
      ),
    );
  ...
  Widget _buildCategoryButtons() {
    return Column(
      children: [
            ...
            return _buildCategoryButton(
              ...
              () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const StatusOrderPage(),
                  ),
                );
              },
        ...
        _buildCategoryButton(
          "Buat Dokumentasi order",
          Icons.build,
          Colors.orange,
          () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => DokumentasiOrderPage()),
            );
          },
        ),
      ],
