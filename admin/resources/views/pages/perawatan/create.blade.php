                            ...
                            <form action="/perawatan" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="inventori_id" name="inventori_id" required>
                                        ...
                                        @foreach ($inventori as $inventory)
                                            <option value="{{ $inventory->id }}" {{ old('inventori_id') == $inventory->id ? 'selected' : '' }}>
                                                {{ $inventory->nama_alat }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="status_perawatan" name="status_perawatan" required>
                                        <option value="pending" {{ old('status_perawatan') == 'pending' ? 'selected' : '' }}>
                                            Pending</option>
                                        <option value="proses" {{ old('status_perawatan') == 'proses' ? 'selected' : '' }}>
                                            Proses</option>
                                        <option value="selesai" {{ old('status_perawatan') == 'selesai' ? 'selected' : '' }}>
                                            Selesai</option>
                                    </select>
                                </div>
