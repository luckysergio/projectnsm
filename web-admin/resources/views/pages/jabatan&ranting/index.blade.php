...
@section('content')
    ...
    @if (session('success'))
        <script>
            Swal.fire({
                ...
                didClose: () => {
                    window.location.href = "/jabatan-jenis";
                }
            });
        </script>
    @endif
    ...
    <div class="container mx-auto p-4">
        ...
        <div class="flex flex-wrap gap-4 mb-6 justify-between">
            <button onclick="openModal('jabatan')" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded shadow">
                + Tambah Jabatan
            </button>
                    ...
                    <table class="min-w-full text-sm text-left">
                        <thead class="bg-blue-600 text-white">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-center">Nama Jabatan</th>
                        ...
                        <tbody class="divide-y divide-gray-200 bg-white">
                            @foreach ($roles as $index => $role)
                                <tr class="hover:bg-gray-50 transition duration-200">
                                    ...
                                    <td class="px-6 py-4 text-center">{{ $role->jabatan }}</td>
                                    <td class="px-6 py-4 text-center space-x-2">
                                        <button
                                            onclick="openEditModal('jabatan', {{ $role->id }}, '{{ $role->jabatan }}')"
    ...
    <div id="modalForm"
        ...
        <div class="bg-white rounded-lg p-6 w-full max-w-md shadow-xl">
            ...
            <form id="modalFormElement" method="POST" action="{{ route('jabatan-jenis.store') }}">
                @csrf
    ...
    <script>
        function openModal(type) {
            ...
            document.getElementById('modalFormElement').action = "{{ route('jabatan-jenis.store') }}";
        ...
        function openEditModal(type, id, nama) {
            ...
            document.getElementById('modalFormElement').action = `/jabatan-jenis/${type}/${id}`;
            ...
            button.addEventListener('click', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.action = `/jabatan-jenis/${type}/${id}`;
                        form.submit();
                    }
                });
            });
